...
public class UpdateProfile extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(requestCode == PICK_IMAGE && resultCode == RESULT_OK && data.getData() != null) {
            ...
            Toast.makeText(UpdateProfile.this, imagePath.toString(), Toast.LENGTH_SHORT).show();
            try {
            ...
            public void onClick(View v) {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(UpdateProfile.this, "Profile Picture Successfully Updated.", Toast.LENGTH_SHORT).show();
                    }
                });
